/**
 * [INPUT]: charId + onClose, 读取 store characters, 调用 stream.ts
...
const P = 'lc'
const STORAGE_KEY = 'lingcao-chats'
...
你现在正在和修仙者闲聊。请完全以${char.name}的性格和说话方式回复。
规则：
- 用第一人称说话，不要用第三人称叙述
...
- 保持角色性格一致`
  ...
  return (
    <>
      ...
      <motion.div
        style={{
          position: 'fixed', inset: 0, background: 'rgba(0,0,0,0.5)', zIndex: 51,
        }}
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        exit={{ opacity: 0 }}
